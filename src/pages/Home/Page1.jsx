...
const page1Data = [
  {
    ...
    svgBg: (
      <svg width="213px" height="303px" viewBox="0 0 213 303" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <circle id="Oval-12-Copy-6" fill="#bb5a5f" opacity="0.45" cx="60" cy="157" r="25" />
        <circle id="Oval-12-Copy" fill="#bb5a5f" opacity="0.35" cx="167.5" cy="65.5" r="11.5" />
        <rect id="Rectangle-14" stroke="#bb5a5f" opacity="0.7" x="0.5" y="54.5" width="14" height="14" rx="1" />
        <circle id="Path" fill="#bb5a5f" opacity="0.5" cx="195.5" cy="117.5" r="3.5" />
        <circle id="Path" fill="#bb5a5f" opacity="0.5" cx="117" cy="2" r="2" />
        <circle id="Path" fill="#bb5a5f" opacity="0.6" cx="82" cy="36" r="2" />
        <circle id="Path" fill="#bb5a5f" opacity="0.6" cx="26.5" cy="102.5" r="1.5" />
        <circle id="Oval-8" stroke="#bb5a5f" opacity="0.65" cx="180.5" cy="8.5" r="4.5" />
        <g id="Group-18" transform="translate(197.000000, 157.000000)" opacity="0.7" stroke="#bb5a5f">
        ...
        <g id="Group-17" transform="translate(124.000000, 284.000000)" opacity="0.65" stroke="#bb5a5f">
  ...
  },
  {
    ...
    svgBg: (
      <svg width="207px" height="295px" viewBox="0 0 207 295" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <rect id="Rectangle-14" stroke="#bb5a5f" opacity="0.7" x="192.5" y="62.5" width="14" height="14" rx="1" />
        <circle id="Oval-12-Copy-2" fill="#bb5a5f" opacity="0.45" cx="21.5" cy="90.5" r="21.5" />
        <circle id="Oval-12-Copy-3" fill="#bb5a5f" opacity="0.35" cx="162.5" cy="163.5" r="14.5" />
        <rect id="Rectangle-14" stroke="#bb5a5f" opacity="0.7" transform="translate(77.500000, 287.500000) rotate(30.000000) translate(-77.500000, -287.500000) " x="72.5" y="282.5" width="10" height="10" rx="1" />
        <circle id="Path" fill="#bb5a5f" opacity="0.5" cx="164.5" cy="117.5" r="3.5" />
        <circle id="Path" fill="#bb5a5f" opacity="0.5" cx="96" cy="2" r="2" />
        <circle id="Path" fill="#bb5a5f" opacity="0.6" cx="141" cy="36" r="2" />
        <circle id="Path" fill="#bb5a5f" opacity="0.6" cx="34.5" cy="142.5" r="1.5" />
        <circle id="Oval-8" stroke="#bb5a5f" opacity="0.65" cx="24.5" cy="30.5" r="4.5" />
        <g id="Group-19" transform="translate(12.000000, 173.000000)" opacity="0.7" stroke="#bb5a5f">
  ...
  },
  {
    ...
    svgBg: (
      <svg width="215px" height="286px" viewBox="0 0 215 286" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" style={{ transform: 'translateX(-30px)' }}>
        <circle id="Oval-12-Copy-4" fill="#s5a5f" opacity="0.35" cx="77" cy="152" r="10" />
        <circle id="Oval-12-Copy-5" fill="#aa5a5f" opacity="0.45" cx="194.5" cy="74.5" r="20.5" />
        <rect id="Rectangle-14" stroke="#aa5a5f" opacity="0.7" x="0.5" y="99.5" width="13" height="13" rx="1" />
        <circle id="Path" fill="#aa5a5f" opacity="0.5" cx="44.5" cy="117.5" r="3.5" />
        <circle id="Path" fill="#aa5a5f" opacity="0.5" cx="132" cy="2" r="2" />
        <circle id="Path" fill="#aa5a5f" opacity="0.6" cx="177" cy="36" r="2" />
        <circle id="Path" fill="#aa5a5f" opacity="0.6" cx="147.5" cy="182.5" r="1.5" />
        <circle id="Oval-8" stroke="#aa5a5f" opacity="0.65" cx="172" cy="182" r="7" />
        <circle id="Oval-8" stroke="#aa5a5f" opacity="0.65" cx="110" cy="280" r="5" />
        <g id="Group-20" transform="translate(70.000000, 23.000000)" opacity="0.7" stroke="#aa5a5f">
  ...
  },
  {
    ...
    svgBg: (
      <svg width="193px" height="286px" viewBox="0 0 193 286" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" style={{ transform: 'translateY(-20px)' }}>
        <circle id="Oval-12-Copy-4" fill="#aa5a5f" opacity="0.35" cx="71" cy="65" r="10" />
        <circle id="Oval-12-Copy-5" fill="#aa5a5f" opacity="0.45" cx="172.5" cy="154.5" r="20.5" />
        <rect id="Rectangle-14" stroke="#aa5a5f" opacity="0.7" x="0.5" y="99.5" width="13" height="13" rx="1" />
        <circle id="Path" fill="#aa5a5f" opacity="0.5" cx="44.5" cy="117.5" r="3.5" />
        <circle id="Path" fill="#aa5a5f" opacity="0.5" cx="132" cy="2" r="2" />
        <circle id="Path" fill="#aa5a5f" opacity="0.6" cx="39" cy="34" r="2" />
        <circle id="Path" fill="#aa5a5f" opacity="0.6" cx="147.5" cy="182.5" r="1.5" />
        <circle id="Oval-8" stroke="#aa5a5f" opacity="0.65" cx="55" cy="177" r="7" />
        <circle id="Oval-8" stroke="#aa5a5f" opacity="0.65" cx="110" cy="280" r="5" />
        <g id="Group-21" transform="translate(171.000000, 25.000000)" opacity="0.7" stroke="#aa5a5f">
